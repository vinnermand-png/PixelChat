...
function getObjectDepth(object: Pick<PlacedObject, "gx" | "gy">) { return object.gx + object.gy; }
function compareObjectDepth(a: PlacedObject, b: PlacedObject) {
  const depthDelta = getObjectDepth(a) - getObjectDepth(b);
  if (depthDelta !== 0) return depthDelta;
  const gyDelta = a.gy - b.gy;
  if (gyDelta !== 0) return gyDelta;
  const gxDelta = a.gx - b.gx;
  if (gxDelta !== 0) return gxDelta;
